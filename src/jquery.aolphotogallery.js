/*global console, document, htmlAdWH, jQuery, location, window, setTimeout: false, screen: false, Image, getIndex*/
/*jslint indent: 2*/
      ...
      var $aolPhotoGallery = $elem,
        ...
        core = {
          ...
          buildGallery: function () {
            ...
            if (options.buildAolShare) {
              if (!$.aolShare) {
                alert("jQuery.aolShare is not defined.");
              } else {
