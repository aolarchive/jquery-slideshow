/*global console, document, htmlAdWH, jQuery, location, window, setTimeout: false, screen: false, getIndex, Image*/
/*
    ...
    * Support AolShare on Embedded mode too.
...
(function ($, window, document, location) {
    ...
    var defaultOptions = {
        ...
        ui: {
            slides: "> .photos > li",
            galleryName: "> h2",
            galleryDescriptionTitle: "> b > a",
            // We use the title attribute on the h2.
                ...
                core = {
                        ...
                        if (totalPhotos) {
                            ...
                            $anchors.each(function (i) {
                                ...
                                var anchorElem = this,
                                    ...
                                    videoEmbedURL = $anchorElem.data("video"),
                                    videoIframe,
                                    videoIframeStyle,
                                ...
                                if (videoEmbedURL) {
                                    ...
                                    videoIframeStyle = videoIframe.style;
                                    videoIframeStyle.display = "none";
                                    $anchorElem.parent().append(videoIframe);
                                }
                    ...
                    buildWallpaper: function () {
                        ...
                        for (i = 0, l = wallpaperSizes.length; i < l; i += 1) {
                            ...
                            wallpaperHTML.push(["<li data-width=\"", wallpaperWidth, "\" data-height=\"", wallpaperHeight, "\">", wallpaperWidth, template.wallpaperSeparator, wallpaperHeight, "</li>"].join(""));
                        }

                        if (options.showOriginalWallpaper) {
                            wallpaperHTML.push(["<li data-width=\"full\" data-height=\"full\">", template.wallpaperOriginal, "</li>"].join(""));
                        }
                    ...
                    bindWallpaper: function () {
                        ...
                        $wallpaperButton.delegate("ul > li", "click." + namespace, function () {
                            ...
                            $wallpaperLink.trigger("wallpaper-download." + namespace, [{
                        ...
                        $slideContainer.queue(function (next) {
                            ...
                            for (i = 0; i < carouselSiblings; i += 1) {
                                ...
                                if (!$nodeNext.length) {
                                    ...
                                    //$slideContainer.attr("");
                                    try { $slideContainer.attr(""); } catch (e) {}
                                }
                            }
                            core.updateCarouselPosition();
                            next();
                    ...
                    updateCarouselPosition: function (oldIndex) {
                        ...
                        if (typeof oldIndex === "number") {
                            ...
                            $slideContainer.queue(function (next) {
                                $slideContainer.css("left", oldPosition + "px");
                                next();
                            });
                            ...
                            if (!$fullscreenPhotoGallery) {
                                ...
                                if (options.fullscreenAdMN) {
                                    ...
                                    if (window.htmlAdWH && options.fullscreenAdMN) {
                                        window.htmlAdWH(options.fullscreenAdMN, options.fullscreenAdWidth, options.fullscreenAdHeight, "ajax", fullscreenAdId);
                                    }
        ...
        */
                    ...
                    bindFullscreenParent: function () {
                        ...
                        $parentGallery.bind("fullscreen-close." + namespace, function () {
                            ...
                            $parentGallery.trigger("status-reset", [{
                                index: activeIndex
                            }]);
                            viewflag = "embed";
                    ...
                    buildGallery: function () {
                        ...
                        core.insertAolShare(); // Insert AolShare widget, when we goto Fullscreen mode for the first time.
                    ...
                    bindGallery: function () {
                        ...
                        if (!isCarousel) {
                            ...
                            $aolPhotoGalleryClone.delegate(".photos > li", "mousedown." + namespace, function () {
                                ...
                                $photo.trigger("photo-mousedown." + namespace, [{
                                    index: photoIndex
                                }]);
                            });
                        }
                        ...
                        $aolPhotoGalleryClone.bind("status-update." + namespace, function (event, data) {
                            ...
                            if ($oldSlide.find("a").data("video")) {
                                $oldSlide.find("iframe").attr({
                                    src: "",
                                    style: "visibility:hidden"
                                });
                            }
                            ...
                            core.insertAolShare(); // Insert AolShare widget
                        });
                    ...
                    bindStatus: function () {
                        ...
                        $aolPhotoGalleryClone.bind("photo-mousedown." + namespace, function (event, data) {
                            ...
                            if (oldIndex !== activeIndex) {
                                $status.html(getStatusTemplate()).trigger("status-update." + namespace, [{
                                    oldIndex: oldIndex,
                                    activeIndex: activeIndex
                                }]);
                            }
            ...
            */
                    ...
                    bindThumbnails: function () {
                        ...
                        $aolPhotoGalleryClone.delegate(".thumbnails > li", "mouseover." + namespace, function () {
                            ...
                            $thumbnail.trigger("thumbnail-mouseover." + namespace, [{
                        ...
                        $aolPhotoGalleryClone.delegate(".thumbnails > li", "mouseout." + namespace, function () {
                            ...
                            var thumbnail = this,
                                $thumbnail = $(thumbnail),
                                thumbnailIndex = +$thumbnail.data("index"); // The + converts the string to a number.
                            $thumbnail.trigger("thumbnail-mouseout." + namespace, [{
                                index: thumbnailIndex
                            }]);
                        ...
                        $aolPhotoGalleryClone.delegate(".thumbnails > li", "mousedown." + namespace, function () {
                            ...
                            var thumbnail = this,
                                $thumbnail = $(thumbnail),
                                thumbnailIndex = +$thumbnail.data("index"); // The + converts the string to a number.
                            $thumbnail.trigger("thumbnail-mousedown." + namespace, [{
                                index: thumbnailIndex
                            }]);
                        ...
                        $aolPhotoGalleryClone.bind("status-update." + namespace, function (event, data) {
                            ...
                            $thumbnails.eq(oldIndex).removeClass("active").fadeTo(speed, 0.7);

                            $thumbnails.eq(activeIndex).addClass("active").fadeTo(speed, 1);
                    ...
                    buildThumbCarousel: function (view) {
                        ...
                        if (totalPhotos >= visible) {
                            ...
                            $view.delegate(".thumbnail-prev", "mousedown." + namespace, function () {
                                $view.trigger("thumbnail-prev-mousedown." + namespace);
                            });

                            $view.delegate(".thumbnail-next", "mousedown." + namespace, function () {
                                $view.trigger("thumbnail-next-mousedown." + namespace);
                            });
...
*/
                ...
                initDeepLinking = function () {
                    ...
                    var testHash = parseHash(deepLinkHashName),
                        pattern = new RegExp(deepLinkHashName + "-[a-zA-Z0-9_-|.]+"),
