	...
	$.aolPhotoGallery = function (customOptions, elem) {
		...
		if (elem) {
			...
			var $aolPhotoGallery = $elem,
				...
				$anchors, $slides, $slideContainer, $captions, $captionContainer, $gallery, $fullscreen, $fullscreenButton, $status, $thumbnailContainer, $thumbnails, $sponsor, $wallpaperButton,
